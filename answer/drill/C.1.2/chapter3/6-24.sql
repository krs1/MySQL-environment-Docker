...
-- 10
SELECT * FROM 注文 WHERE 注文日 >= '2024-01-01'

-- 11
SELECT * FROM 注文 WHERE 注文日 < '2023-12-01'
...
-- 21
SELECT * FROM 商品 WHERE (商品区分 = '1' AND 単価 <= 3000)
OR (商品区分 = '3' AND 単価 >= 10000)

-- 22
SELECT 商品コード FROM 注文 WHERE 注文日 >= '2024-03-01'
AND 注文日 < '2024-04-01' AND 数量 >= 3
